...
namespace lista_do_while
{
    internal class Program
    {
        public static void Exercicio1() {
            Console.WriteLine("aqui sera codificado o exercicio 1");
        ...
        public static void Exercicio2() {
            Console.WriteLine("aqui sera codificado o exercicio 2");
            string produto;
            int quantidade;
            decimal preco;
        ...
        public static void Exercicio3() {
            Console.WriteLine("aqui sera codificado o exercicio 3");
        ...
        public static void Exercicio4() {
            Console.WriteLine("aqui sera codificado o exercicio 4");
            string sigla;
            string nomeEstado;
            ...
            do
            {
                ...
                Console.WriteLine("Nome do estado: " + nomeEstado);

            } while (sigla != "SAIR");
        }
        public static void Exercicio5() {
            Console.WriteLine("aqui sera codificado o exercicio 5");
            int mes;
            string estacao = "";
            ...
            do
            {
                ...
                Console.WriteLine("Estação do ano correspondente: " + estacao);

            } while (mes < 1 || mes > 12);
        }
        public static void Exercicio6() {
            Console.WriteLine("aqui sera codificado o exercicio 6");
            string comando;
        ...
        public static void Exercicio7() {
            Console.WriteLine("aqui sera codificado o exercicio 7");
            int numero;
